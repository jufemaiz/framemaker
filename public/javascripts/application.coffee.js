updateFrame = () ->
  ...
  height_ratio = 1
  leFrame = $("#canvas")
  frame_width = $("form input#frameWidth").val() * 1
  frame_colour = $("form input#frameColour").val()
  matt_width = $("form input#matt0Width").val() * 1
  matt_colour = $("form input#matt0Colour").val()
  picture_height = $("form input#imageHeight").val() * 1
  picture_width = $("form input#imageWidth").val() * 1
  picture_source = $("form input#imageSource").val()
